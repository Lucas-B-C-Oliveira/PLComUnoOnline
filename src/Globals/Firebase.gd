...
const API_KEY: String = "AIzaSyBm2OwyAISIRzcn1dgWJYvhJojNFcrAg5A"
const PROJECT_ID: String = "projeto-de-lei-com-uno"


const REGISTER_URL: String = "https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=%s" % API_KEY
const LOGIN_URL: String = "https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=%s" % API_KEY
